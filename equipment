...
Characters have a purse which contains 1d6 x 10 coins with which to buy equipment. Equipment is bought from NPC in a shop, stolen or traded with another character.
...
Small items, Holy Symbols, Lucky charms Vails, Mirrors	D6	25	1	2	+1 WIS when banishing
Clothes		10	1	1	
Leather		20	1	1	+1 AP
